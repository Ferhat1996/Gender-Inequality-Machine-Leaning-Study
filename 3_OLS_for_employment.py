...
wage_model_2005_female = sm.OLS(data_2005_female['emp'], independent_vars_2005_female)
...
custom_summary_2005_female = summary_col([results_2005_female], stars=True, float_format='%0.3f', model_names=['Employment'])
...
# Drop the columns 'year', 'emp', 'female', 'hourly_wage', and 'id' from the independent variables
independent_vars_2005_male = data_2005_male.drop(columns=['year', 'emp', 'hourly_wage', 'female', 'id', 'Employment'])
...
wage_model_2005_male = sm.OLS(data_2005_male['emp'], independent_vars_2005_male)
...
custom_summary_2005_male = summary_col([results_2005_male], stars=True, float_format='%0.3f', model_names=['Employment'])
...
wage_model_2010_female = sm.OLS(data_2010_female['emp'], independent_vars_2010_female)
...
custom_summary_2010_female = summary_col([results_2010_female], stars=True, float_format='%0.3f', model_names=['Employment'])
...
wage_model_2010_male = sm.OLS(data_2010_male['emp'], independent_vars_2010_male)
...
custom_summary_2010_male = summary_col([results_2010_male], stars=True, float_format='%0.3f', model_names=['Employment'])
...
result_df.to_excel("OLS_employment_summary.xlsx", index=False)